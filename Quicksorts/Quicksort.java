 ...
 *
 * This class implements quicksort from CLRS using the normal pivot 
 * selection process.
 ***********************************************************************/
...
public class Quicksort implements Sorter
{
	...
	// normal pivot selection process
    private static int amtOfWorkForNormal = 0;
     ...
     *
     * @return amtOfWorkForNormal Keep track of work done
     */
    public int getWork()
    {
    	return amtOfWorkForNormal;
    }
}
